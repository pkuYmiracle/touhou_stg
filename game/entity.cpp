...
QVector2D Entity::getSpeed() const { return speed; }

void Entity::setSpeed(QVector2D newSpeed) { speed = newSpeed; }
...
void Entity::advance(int phase) {
    ...
    if (this->isPlayer()) {
        ...
        if (GAME_BOARD_RECT
                .adjusted(-HIDEN_EDGE, -HIDEN_EDGE, HIDEN_EDGE, HIDEN_EDGE)
                .intersects(this->mapRectToScene(this->boundingRect())) ==
            false) {
...
bool Entity::isEnemy() const { return dynamic_cast<const Enemy *>(this) != 0; }

...
BulletGroup *Player::getBulletGroup() const { return bulletGroup; }

void Player::setBulletGroup(BulletGroup *newBulletGroup) {
    bulletGroup = newBulletGroup;
}

Player::Player(GameController *gc, QString pixmap_url) : gc(gc) {
...
void Player::advance(int phase) {
    ...
    qreal speed_rates = kb->isKeyPressed(Qt::Key_Shift)

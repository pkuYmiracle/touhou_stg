...
BulletGroup::BulletGroup() : bullets() {}
...
void generate_bg(BulletGroup &bg, double bg_atk, QString bg_picUrl, double n0,
                 double n1, double n2,
                 double n3 = 0) {  //生成圆（n0等分；半径n1;速度n2;相位n3)
    for (int i = 0; i < n0; i++)
        bg.bullets.push_back(BulletPrototype(
            {static_cast<float>(n1 * cos(2 * pi * i / n0 + n3)),
             static_cast<float>(n1 * sin(2 * pi * i / n0 + n3))},
            {static_cast<float>(n2 * cos(2 * pi * i / n0 + n3)),
...
void initBulletGroups() {
    ...
    bg_blue01.bullets.push_back(BulletPrototype(
        {8.7, 7.5}, {1.732, 1.5}, 1, ":/game/assets/bullet_blue02.png"));
    bg_blue01.bullets.push_back(BulletPrototype(
        {7.5, 8.7}, {1.5, 1.732}, 1, ":/game/assets/bullet_blue02.png"));
    bg_blue01.bullets.push_back(BulletPrototype(
        {-7.5, 8.7}, {-1.5, 1.732}, 1, ":/game/assets/bullet_blue02.png"));
    bg_blue01.bullets.push_back(BulletPrototype(
        {-8.7, 7.5}, {-1.732, 1.5}, 1, ":/game/assets/bullet_blue02.png"));
    ...
    bg_blue03.bullets.push_back(BulletPrototype(
        {4.33, 2.50}, {1.73, 1.00}, 1, ":/game/assets/bullet_blue03.png"));
    bg_blue03.bullets.push_back(BulletPrototype(
        {3.54, 3.54}, {1.41, 1.41}, 1, ":/game/assets/bullet_blue03.png"));
    bg_blue03.bullets.push_back(BulletPrototype(
        {2.50, 4.33}, {1.00, 1.73}, 1, ":/game/assets/bullet_blue03.png"));
    bg_blue03.bullets.push_back(BulletPrototype(
        {1.29, 4.83}, {0.52, 1.93}, 1, ":/game/assets/bullet_blue03.png"));
    bg_blue03.bullets.push_back(BulletPrototype(
        {0.00, 5.00}, {0.00, 2.00}, 1, ":/game/assets/bullet_blue03.png"));
    bg_blue03.bullets.push_back(BulletPrototype(
        {-1.29, 4.83}, {-0.52, 1.93}, 1, ":/game/assets/bullet_blue03.png"));
    bg_blue03.bullets.push_back(BulletPrototype(
        {-2.50, 4.33}, {-1.00, 1.73}, 1, ":/game/assets/bullet_blue03.png"));
    ...
    bg_yellow_star.bullets.push_back(BulletPrototype(
        {0.00, -5.00}, {0.00, -4.00}, 1, ":/game/assets/bullet_yellow.png"));
    bg_yellow_star.bullets.push_back(BulletPrototype(
        {4.76, -1.55}, {3.80, -1.24}, 1, ":/game/assets/bullet_yellow.png"));
    bg_yellow_star.bullets.push_back(BulletPrototype(
        {2.94, 4.05}, {2.35, 3.24}, 1, ":/game/assets/bullet_yellow.png"));
    bg_yellow_star.bullets.push_back(BulletPrototype(
        {-2.94, 4.05}, {-2.35, 3.24}, 1, ":/game/assets/bullet_yellow.png"));
    bg_yellow_star.bullets.push_back(BulletPrototype(
        {-4.76, -1.55}, {-3.80, -1.24}, 1, ":/game/assets/bullet_yellow.png"));
    bg_yellow_star.bullets.push_back(BulletPrototype(
        {0.00, 5.00}, {0.00, 2.00}, 1, ":/game/assets/bullet_yellow.png"));
    bg_yellow_star.bullets.push_back(BulletPrototype(
        {-4.76, 1.55}, {-1.90, 0.62}, 1, ":/game/assets/bullet_yellow.png"));
    bg_yellow_star.bullets.push_back(BulletPrototype(
        {-2.94, -4.05}, {-1.18, -1.62}, 1, ":/game/assets/bullet_yellow.png"));
    bg_yellow_star.bullets.push_back(BulletPrototype(
        {2.94, -4.05}, {1.18, -1.62}, 1, ":/game/assets/bullet_yellow.png"));
    bg_yellow_star.bullets.push_back(BulletPrototype(
        {4.76, 1.55}, {1.90, 0.62}, 1, ":/game/assets/bullet_yellow.png"));
    ...
    n2 = 3;
    for (int i = 0; i < n0; i++)
        bg_06.bullets.push_back(BulletPrototype(
            {static_cast<float>(n1 * cos(2 * pi * i / n0 + pi * 0.3)),
             static_cast<float>(n1 * sin(2 * pi * i / n0 + pi * 0.3))},
            {static_cast<float>(n2 * cos(2 * pi * i / n0 + pi * 0.3)),
    ...
    n2 = 2;
    for (int i = 0; i < n0; i++)
        bg_07.bullets.push_back(BulletPrototype(
            {static_cast<float>(n1 * cos(2 * pi * i / n0 + pi / 3)),
             static_cast<float>(n1 * sin(2 * pi * i / n0 + pi / 3))},
            {static_cast<float>(n2 * cos(2 * pi * i / n0 + pi / 3)),
    ...
    n2 = 4;
    for (int i = 0; i < n0; i++)
        bg_08.bullets.push_back(BulletPrototype(
            {static_cast<float>(n1 * cos(2 * pi * i / n0 + pi / 3)),
             static_cast<float>(n1 * sin(2 * pi * i / n0 + pi / 3))},
            {static_cast<float>(n2 * cos(2 * pi * i / n0 + pi / 3)),
             static_cast<float>(n2 * sin(2 * pi * i / n0 + pi / 3))},
